...
2. **KKit-INSTANCE-A** (this repo) — Daemon-side changes to `cowork-bridge.ts`. Adds token auth, X25519 key exchange, AES-256-GCM encryption, PSK management endpoints, and TOFU fingerprint support.
...
### Modified Files (KKit-INSTANCE-A repo)
...
### New Files (KKit-INSTANCE-A repo)
