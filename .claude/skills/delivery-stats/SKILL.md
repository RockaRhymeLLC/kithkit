...
### Failures (1)
- 2026-02-03 04:13 — chat 0000000000, hash 26c798da, 184 chars, exhausted after 61s
...
|------------|-----------|------------------|--------:|------------|-----:|
| 15:16:28   | delivered | retry            |    16s  | 0000000000 |  134 |
| 15:16:11   | delivered | stop-hook        |     0s  | 0000000000 |  261 |
| ...        | ...       | ...              |    ...  | ...        |  ... |
```
...
|------------------|------------|----------|----:|--------:|--------:|
| 2026-02-03 04:13 | 0000000000 | 26c798da | 184 |    61s  |      64 |
```
...
|----------|------:|---------------------|--------------------------|
| 26c798da |     4 | 3 delivered, 1 fail | 0000000000               |
| ...      |   ... | ...                 | ...                      |
```
