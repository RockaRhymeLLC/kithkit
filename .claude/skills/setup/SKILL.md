---
name: setup
description: Interactive setup wizard for configuring the assistant after cloning CC4Me. Use when setting up a new instance, reconfiguring identity, autonomy mode, integrations (Telegram, email), or troubleshooting installation.
...
See `.claude/skills/email/{agent}-m365.md` for detailed Azure setup.
...
5. Once approved, agent can send/receive P2P messages directly with other agents (relay provides directory only, messages never pass through it)
