...
```bash
node .claude/skills/cowork/scripts/cdp-status.mjs 192.0.2.147 9222
```
...
```bash
node .claude/skills/cowork/scripts/cdp-snapshot.mjs 192.0.2.147 9222 0
```
...
```bash
node .claude/skills/cowork/scripts/cdp-screenshot.mjs 192.0.2.147 9222 /path/to/output.png 0
```
...
BMO tests remotely: `curl http://192.0.2.147:9222/json/version`
...
```bash
# List all tabs
curl -s http://192.0.2.147:9222/json/list

# Open new tab
curl -s http://192.0.2.147:9222/json/new?https://example.com

# Close a tab by ID
curl -s http://192.0.2.147:9222/json/close/{tabId}

# Browser version info
curl -s http://192.0.2.147:9222/json/version
```
