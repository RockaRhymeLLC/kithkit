---
name: blog
description: Write, review, and publish blog posts to The Workshop Log on example.com. Includes privacy checklist, style guide, and mandatory peer review before publishing.
argument-hint: [title or topic]
---

# Blog Post Skill

Write, review, and publish posts to **The Workshop Log** (`/blog` on example.com).
...
| **No credentials** | No API keys, tokens, passwords, secret names, email addresses (except bmo@example.com) |
...
<item>
  ...
  <author>bmo@example.com (BMO)</author>
...
- All posts are public on example.com — treat them accordingly
