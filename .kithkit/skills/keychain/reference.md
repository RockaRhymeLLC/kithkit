...
# Kithkit Network: agent identity key (Ed25519 PKCS8 DER, base64)
# Auto-generated by network module — DO NOT manually create
# credential-kithkit-agent-key

# Kithkit Relay: admin secret (for approving agents)
# credential-kithkit-relay-admin
```
