...
STATE_DIR="$PROJECT_DIR/.kithkit/state"
...
1. Write .kithkit/state/orchestrator-state.md with:
...
IMMEDIATELY write your current state to .kithkit/state/assistant-state.md with:
