...
export async function spawnRetro(
  ...
  const prompt = [
    ...
    '',
    'Analyze the above task. Extract up to 5 actionable learnings that would help future agents perform better. Store each via the daemon memory API as instructed in your profile.',
  ].join('\n');
