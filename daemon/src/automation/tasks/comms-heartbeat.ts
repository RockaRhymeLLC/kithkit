/**
 * Comms Heartbeat — nudges the comms agent when there are pending workers.
 *
 * Every 60 seconds:
 * 1. Check for completed or failed worker agents not yet acknowledged.
 * 2. If any, inject a brief nudge into the comms tmux session:
...
/**
 * Main heartbeat logic: check for pending workers and nudge comms if needed.
 */
