 ...
 * emails a readable report to redacted@outlook.com via Microsoft Graph API, then
...
const SENDER_EMAIL = 'bmo@example.com';
const RECIPIENT_EMAIL = 'redacted@outlook.com';
