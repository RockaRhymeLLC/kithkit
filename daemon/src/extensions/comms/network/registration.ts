 ...
 */
export async function registerWithRelay(config: BmoConfig): Promise<RegistrationResult> {
...
export async function checkRegistrationStatus(config: BmoConfig): Promise<RegistrationResult> {
  const network = config.network;
