...
const log = createLogger('r2-access-control');
 ...
 */
export function initR2AccessControl(): void {
  registerTier('r2-extended', (senderId: string) => {
  ...
  log.info('R2 access control initialized (5-tier, channel-aware)');
}
