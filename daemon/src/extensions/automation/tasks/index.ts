/**
 * R2 Scheduler Tasks — registers all R2-specific task handlers.
 *
...
/**
 * Register all R2-specific task handlers with the scheduler.
 * Called from the R2 extension's onInit().
 *
