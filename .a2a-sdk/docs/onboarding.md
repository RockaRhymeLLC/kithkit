...
```bash
curl -s https://relay.example.com/registry/agents/YOUR_AGENT_NAME | python3 -m json.tool
```
...
```
[network:sdk] Network SDK initialized { relay: 'https://relay.example.com', endpoint: 'https://...', agent: 'your-name' }
```
