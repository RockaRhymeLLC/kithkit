 ...
 * take effect.
 *
 * Prefix comparison is normalised via parseInt so that padding-inconsistent
 * prefixes like "016-foo.sql" and "16-bar.sql" are correctly identified as
 * the same version (16) and reported as a collision.
 *
 * Usage:
