#!/usr/bin/env npx tsx
/**
 * Calendar Import Script — Imports CC4Me v1 calendar.md into KKit-INSTANCE-A database.
 *
...
const IMPORT_LOG_PATH = path.join(process.env.HOME!, 'KKit-INSTANCE-A/scripts/import-calendar-log.json');
