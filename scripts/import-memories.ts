#!/usr/bin/env npx tsx
/**
 * Memory Import Script — Imports triaged memories into KKit-INSTANCE-A database.
 *
...
const REPORT_PATH = path.join(process.env.HOME!, 'KKit-INSTANCE-A/scripts/triage-report.json');
const IMPORT_LOG_PATH = path.join(process.env.HOME!, 'KKit-INSTANCE-A/scripts/import-log.json');
const DB_PATH = path.join(process.env.HOME!, 'KKit-INSTANCE-A/kithkit.db');
