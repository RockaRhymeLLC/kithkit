#!/usr/bin/env npx tsx
/**
 * Todo Import Script — Imports CC4Me v1 todos into KKit-INSTANCE-A database.
 *
...
const IMPORT_LOG_PATH = path.join(process.env.HOME!, 'KKit-INSTANCE-A/scripts/import-todos-log.json');
